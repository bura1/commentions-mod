...
return [
    ...
    */
    'comment' => [
        'model' => \Bura1\Commentions\Comment::class,
        'policy' => \Bura1\Commentions\Policies\CommentPolicy::class,
    ],
    ...
    */
    'notifications' => [
        'mentions' => [
            ...
            'listener' => \Bura1\Commentions\Listeners\SendUserMentionedNotification::class,
            'notification' => \Bura1\Commentions\Notifications\UserMentionedInComment::class,
