...
class CommentCustom extends Component
{
    use HasMentions;
    ...
    {
        if ($this->comment->commentable_type == Reminder::class) {
            $this->subtitle = 'Added a note on <strong>' . $this->comment->commentable->title . '</strong>';
        }

        return view('commentions::comment-custom');
    }
