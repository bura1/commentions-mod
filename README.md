...
[![CI](https://github.com/bura1-development/commentions/actions/workflows/ci.yml/badge.svg)](https://github.com/bura1-development/commentions/actions/workflows/ci.yml)
[![MIT Licensed](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Latest Version on Packagist](https://img.shields.io/packagist/v/bura1-development/commentions.svg?style=flat-square)](https://packagist.org/packages/bura1-development/commentions)
[![Total Downloads](https://img.shields.io/packagist/dt/bura1-development/commentions.svg?style=flat-square)](https://packagist.org/packages/bura1-development/commentions)
...
```bash
composer require bura1-development/commentions
```
...
```php
use Bura1\Commentions\Filament\Actions\CommentsTableAction;
...
```php
use Bura1\Commentions\Filament\Actions\CommentsAction;
...
```php
use Bura1\Commentions\Filament\Actions\SubscriptionAction;
...
```php
use Bura1\Commentions\Filament\Infolists\Components\CommentsEntry;
...
If you need to customize the Comment model, you can extend the `\Bura1\Commentions\Comment` class and then update the `comment.model` option in your `config/commentions.php` file:
...
use Bura1\Commentions\Contracts\Commenter;
use Bura1\Commentions\Policies\CommentPolicy as CommentionsPolicy;
...
- `Bura1\Commentions\Events\UserWasMentionedEvent`
- `Bura1\Commentions\Events\UserIsSubscribedToCommentableEvent`
- `Bura1\Commentions\Events\CommentWasCreatedEvent`
- `Bura1\Commentions\Events\CommentWasReactedEvent`
...
Every time a user is mentioned, the `Bura1\Commentions\Events\UserWasMentionedEvent` is dispatched. Commentions ships an optional, opt-in notification you can enable via configuration, or you can listen to the event and handle it yourself.
...
Config::resolveCommentUrlUsing(function (\Bura1\Commentions\Comment $comment) {
...
Sometimes you might want to render non-Comments in the list of comments. For example, you might want to render when the status of a project is changed. For this, you can override the `getComments` method in your model, and return instances of the `Bura1\Commentions\RenderableComment` data object.

```php
use Bura1\Commentions\RenderableComment;
...
If you discover any security related issues, please email security@bura1development.com instead of using the issue tracker.

## Credits

- [Luis Dalmolin](https://github.com/luisdalmolin)
- [All contributors](https://github.com/bura1-development/commentions/graphs/contributors)

## Sponsorship

Development of this package is sponsored by Bura1 Development Group, a developer driven company focused on problem solving, team building, and community. Learn more [about us](https://bura1development.com?utm_source=github) or [join us](https://careers.bura1development.com?utm_source=github)!
